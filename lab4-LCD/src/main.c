    ...
    if (no_of_overflows >= 6)
    {
        ...
        if(tenths > 9){
          ...
          if (u_secs > 59){
            ...
            itoa(u_secs, string, 10);  // Convert decimal value to string
            lcd_gotoxy(4, 0);

            if(u_secs < 10){
               lcd_puts("0"); //Set 00:0X.0
            }
            
            lcd_puts(string); //Set 00:0X.0
